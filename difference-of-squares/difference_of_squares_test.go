...
func BenchmarkSquareOfSumsNaive(b *testing.B) {
	for i := 0; i < b.N; i++ {
		SquareOfSumsNaive(100)
	}
}

func BenchmarkSumOfSquaresNaive(b *testing.B) {
	for i := 0; i < b.N; i++ {
		SumOfSquaresNaive(100)
	}
}

func BenchmarkDifferenceNaive(b *testing.B) {
	for i := 0; i < b.N; i++ {
		DifferenceNaive(100)
	}
}
